...
3. If for any reason that does not work, you can also ask in translatewiki's [IRC channel](https://translatewiki.net/wiki/Special:WebChat) or [Telegram group](https://t.me/translatewiki).
...
If your language is not available, please create a new GitHub issue asking for it, and we will add it as soon as possible. Thanks!

# Internals

## How translations make their way into the app
The translations from the project are [periodically committed directly to this project](https://github.com/commons-app/apps-android-commons/commits/master?author=) by the team and later released with the normal updates to the Play Store. This means that you just need to translate, and your translations will automatically be used by the app from the next [release](https://github.com/commons-app/apps-android-commons/releases). Only languages where more than 25% of the strings have been translated get exported.

The translatewiki platform is configured to export a certain list of languages to a certain file in this repo. 
