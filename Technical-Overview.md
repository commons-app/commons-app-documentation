The [general user facing functionality of the app is already documented](App Functionality), this document should try to connect that to the actual code in the repo: What code is there and does what?
